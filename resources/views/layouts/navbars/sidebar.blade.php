            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('borrower.index') }}">
                        <i class="fa fa-address-book-o text-primary"></i> {{ __('Borrowers') }}
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('loans.index') }}">
                        <i class="fa fa-list-alt text-primary"></i> {{ __('Loans') }}
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('payments.index') }}">
                        <i class="ni ni-collection text-primary"></i> {{ __('Payments') }}
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('loans.calculator') }}">
                        <i class="fa fa-calculator text-primary"></i> {{ __('Loan Calculator') }}
                    </a>
                </li>
            </ul>
        </div>
